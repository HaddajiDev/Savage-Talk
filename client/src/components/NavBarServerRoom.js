...
import { GetServerOne } from '../redux/GroupSlice';
import { useDispatch, useSelector } from 'react-redux';
import { logout } from '../redux/UserSlice';

function NavBarServerRoom() {
                    ...
                    <nav className="dashboard-nav-list">
                        ...
                        <div className='dashboard-nav-dropdown'>
                            ...
                            <div className='dashboard-nav-dropdown-menu'>
                                ...
                                <a className="dashboard-nav-dropdown-item pointer" onClick={() => navigate('/myServers')}>Joined servers</a>
                                <a className="dashboard-nav-dropdown-item pointer" onClick={() => navigate('/createServer')}>Create a Server</a>
                            </div>
                        </div>
                        <a className="dashboard-nav-item pointer active">
                            <i><img style={{width: '30px', borderRadius: '50%'}} src={server?.imageUrl}/></i>{server?.GroupName}
                        </a>
...
export default NavBarServerRoom;
